...
download = drive.find_element(By.CLASS_NAME, "result-data u-align-left").text
upload = drive.find_element(By.CLASS_NAME, "result-item result-item-first-class result-item-upload updated test-mode-multi").find_element("result-data u-align-left").text
